...
A software for collecting and analyzing decay lifetime and energy of muons from cosmic ray based on TeX 1012b oscilloscope
...
Running environment:
    ...
    PYTHON PACKAGES:
        ...
        pyinstaller-4.2
    USE:
	pyinstaller -F -i .\bitbug_favicon.ico .\MainMuonDetector.py
    Tektronix support:
